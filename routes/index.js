var Fs = require("fs"), Namer = require("../lib/namer"), Path = require("path"), Renderer = require('../lib/renderer'), Locker = require("../lib/locker"), Tools = require("../lib/tools"), Url = require("url");
...
exports.pageList = function(req, res) {
    ...
    var running = 0, limit = 10, counter = 0;
    ...
    function launcher(list) {
        while (running < limit && counter < len) {
            var page = list[counter];
            counter++;
            page = Path.basename(page);
            async(page, function(result) {
                items.push(result);
                running--;
                if (items.length < len) {
                    launcher(list);
...
exports.pageShow = function(req, res) {
    ...
    var pageName = req.params.page, pageVersion = req.params.version || "HEAD";
    ...
    Git.readFile(pageName + ".md", pageVersion, function(err, content) {
        ...
        if (err) {
            ...
            Git.log(pageName + ".md", pageVersion, function(err, metadata) {
                ...
                if (pageVersion != 'HEAD') {
                    res.locals.warning = "You're not reading the latest revision of this page, which is " + "<a href='/wiki/"
                            + pageName + "'>here</a>.";
...
exports.pageCreate = function(req, res) {
    ...
    var errors, pageName, pageFile, hasPageName = !!req.body.pageName;
...
exports.pageEdit = function(req, res) {
    ...
    var pageName = res.locals.pageName = req.params.page, lock;
...
exports.pageUpdate = function(req, res) {
    ...
    var pageName = res.locals.pageName = Namer.normalize(req.params.page), errors, pageFile, message, content;
...
exports.pageCompare = function(req, res) {
    ...
    var pageName = req.params.page, revisions = req.params.revisions;
...
exports.pageHistory = function(req, res) {
    ...
    var pageName = req.params.page, pageTitle;
...
exports.miscExistence = function(req, res) {
    ...
    var result = [], n = req.query.data.length;
...
exports.authDone = function(req, res) {
    ...
    if (!app.locals.authentication.alone.used
            && !Tools.isAuthorized(res.locals.user.email, app.locals.authorization.validMatches)) {
        req.logout();
        req.session = null;
        res.statusCode = 403;
